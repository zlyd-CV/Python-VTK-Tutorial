...
def main():
    ...
    sp_id = sourcePoints.InsertNextPoint(10.0, 1.0, 0.0)
    sourceVertices.InsertNextCell(1)
    sourceVertices.InsertCellPoint(sp_id)

    sp_id = sourcePoints.InsertNextPoint(1.0, 11, 0.0)
    sourceVertices.InsertNextCell(1)
    sourceVertices.InsertCellPoint(sp_id)

    sp_id = sourcePoints.InsertNextPoint(0.0, 1.0, 10.0)
    sourceVertices.InsertNextCell(1)
    sourceVertices.InsertCellPoint(sp_id)
    ...
    tp_id = targetPoints.InsertNextPoint(10.0, 0.0, 0.0)
    targetVertices.InsertNextCell(1)
    targetVertices.InsertCellPoint(tp_id)

    tp_id = targetPoints.InsertNextPoint(0.0, 10.0, 0.0)
    targetVertices.InsertNextCell(1)
    targetVertices.InsertCellPoint(tp_id)

    tp_id = targetPoints.InsertNextPoint(0.0, 0.0, 10.0)
    targetVertices.InsertNextCell(1)
    targetVertices.InsertCellPoint(tp_id)
